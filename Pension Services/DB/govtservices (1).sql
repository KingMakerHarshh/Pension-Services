...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2021 at 07:42 PM
...
--
-- Table structure for table `tblcoordinators`
--
...
--
-- Dumping data for table `tblcoordinators`
--

INSERT INTO `tblcoordinators` (`ID`, `Coordinator`, `Qualification`, `Designation`, `Mobile`, `EmailID`, `Category`) VALUES
(, '', '', '', '', '', '');
...
INSERT INTO `tbldocuments` (`ID`, `ServiceID`, `UserID`, `DocumentType`, `Document`) VALUES
(, , '', '', ''),
(, , '', '', '');
...
CREATE TABLE `tbldocumenttypes` (
  `ID` int(11) NOT NULL,
  `DocumentTypes` varchar(100) NOT NULL,
  `ServiceID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbldocumenttypes` (`ID`, `DocumentTypes`, `ServiceID`) VALUES
(, '', ),
(, '', );
...
(1, 'admin', 'admin', 'Admin'),
(17, '9945239371', '000000', 'Users'),
(19, '6360024352', '000000', 'Coordinators');
...
INSERT INTO `tblrequest` (`ID`, `ServiceID`, `UserID`, `Status`) VALUES
(, , '', '');
...
CREATE TABLE `tblservices` (
  ...
  `AboutService` varchar(500) NOT NULL,
  `Coordinator` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tblservices` (`ID`, `Service`, `Category`, `Eligibility`, `Reservation`, `Subsidy`, `AboutService`, `Coordinator`) VALUES
(, '', '', '', '', '', '', '');
...
INSERT INTO `tblusers` (`ID`, `Name`, `Aadhaar`, `Address`, `State`, `City`, `Mobile`, `EmailID`, `Category`) VALUES
(, '', '', '', '', '', '', '', '');
...
--
-- Indexes for table `tblcoordinators`
--
ALTER TABLE `tblcoordinators`
  ADD PRIMARY KEY (`ID`);
...
--
-- Indexes for table `tbldocumenttypes`
--
ALTER TABLE `tbldocumenttypes`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `tblcoordinators`
--
ALTER TABLE `tblcoordinators`
...
--
-- AUTO_INCREMENT for table `tbldocumenttypes`
--
ALTER TABLE `tbldocumenttypes`
