...
<body>
 ...
 <div id="wrap">
				...
				<div id="top_padding">
					...
					<div id="menu">
          <ul>
          <li><a href="CoordinatorsServicesList.php">Services</a></li>
		      <li><a href="CoordinatorsRequestList.php">Request</a></li>
          <li><a href="CoordinatorsReport1.php">Report</a></li>
          <li><a href="CoordinatorsInfo.php">Info</a></li>
